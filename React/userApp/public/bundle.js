...
/***/ function(module, exports, __webpack_require__) {
	...
	var PersonsContainer = __webpack_require__(158);

	ReactDOM.render(React.createElement(PersonsContainer, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(146);
	var PersonsTable = __webpack_require__(159);
	var AddNewPerson = __webpack_require__(160);

	var PersonsContainer = React.createClass({
	    displayName: 'PersonsContainer',
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(PersonsTable, { users: this.state.users }),
	            React.createElement(AddNewPerson, { newUser: this.state.newUser, onChange: this._handleChange, onSave: this._addNewPerson,
	                errors: this.state.errors })
	        );
	    },

	    _isInputValid: function _isInputValid() {
	        var isValid = true;
	        var errors = {};
	    ...
	    _generateEmptyUser: function _generateEmptyUser() {
	        return {
	            id: null,
	            name: '',
	            email: '',
	    ...
	    _generateUserId: function _generateUserId(users) {
	        if (users.length > 0) {
	    ...
	    _addNewPerson: function _addNewPerson(e) {
	        e.preventDefault();
	    ...
	    componentDidMount: function componentDidMount() {
	        // is een handige voor data op te halen
	    ...
	    componentWillUnmount: function componentWillUnmount() {
	        // zou bv triggeren wanneer je naar een andere route zou gaan, zo kan je zaken destroyeen en cleanen
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PersonsTable = React.createClass({
	    ...
	    _renderPersons: function _renderPersons() {
	        var self = this;
	        ...
	        return this.props.users.map(function (user, index) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    "td",
	                    null,
	                    self._renderMarried(user.married)
	                )
	            );
	        });
	    },

	    _renderMarried: function _renderMarried(married) {

	        if (married) {
	            return React.createElement("span", { className: "glyphicon glyphicon-check" });
	        }

	        return React.createElement("span", { className: "glyphicon glyphicon-unchecked" });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNewPerson = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: this._addStyleOnError(this.props.errors.name) },
	                    React.createElement(
	                        "label",
	                        { htmlFor: "exampleInputName" },
	                        "Name"
	                    ),
	                    React.createElement("input", { type: "text", className: "form-control", value: this.props.newUser.name, name: "name",
	                ...
	                React.createElement(
	                    "div",
	                    { className: this._addStyleOnError(this.props.errors.email) },
	                    React.createElement(
	                        "label",
	                        { htmlFor: "exampleInputEmail" },
	                        "Email address"
	                    ),
	                    React.createElement("input", { type: "email", className: "form-control", name: "email", value: this.props.newUser.email,
	                ...
	                React.createElement(
	                    "div",
	                    { className: this._addStyleOnError(this.props.errors.age) },
	                    React.createElement(
	                        "label",
	                        { htmlFor: "exampleInputAge" },
	                        "Age"
	                    ),
	                    React.createElement("input", { type: "number", className: "form-control", name: "age", value: this.props.newUser.age,
	                        onChange: this.props.onChange, placeholder: "Age" }),
	                    React.createElement(
	                        "div",
	                        { style: { 'color': 'red' } },
	                        this.props.errors.age
	                    )
	                ),
	                React.createElement(
	                    "div",
	                    { className: this._addStyleOnError(this.props.errors.birthday) },
	                    React.createElement(
	                        "label",
	                        { htmlFor: "exampleInputBirthday" },
	                        "Birthday"
	                    ),
	                    React.createElement("input", { type: "date", className: "form-control", name: "birthday", value: this.props.newUser.birthday,
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "label",
	                        { htmlFor: "exampleInputMarried" },
	                        "Married"
	                    ),
	                    React.createElement("input", { type: "checkbox", checked: this.props.newUser.married, className: "form-control",
	                        name: "married",
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "button",
	                        { type: "submit", className: "btn btn-default", onClick: this.props.onSave },
	                        "Submit"
	                    )
	                )
	            )
	    ...
	    _addStyleOnError: function _addStyleOnError(elem) {
